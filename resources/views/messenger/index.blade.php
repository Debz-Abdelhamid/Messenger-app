  ...
  @include('messenger.layouts.user-list-sidebar')
    ...
    <div class="wsus__chat_area">
        ...
        <div class="wsus__message_paceholder_black d-flex justify-content-center align-items-center">
            <span class="select_user">Select User For Start Conversation</span>
        </div>

        <div class="wsus__chat_area_header messenger-header">
            ...
            <div class="footer_message">
                ...
                <form action="#" class="message-form" enctype="multipart/form-data" >
                    <div class="file">
                        ...
                        <input id="file" type="file" hidden class="attachment-input" name="attachment" accept="image/png,image/jpg,image/jpeg">
                    </div>
