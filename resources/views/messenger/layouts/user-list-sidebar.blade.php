<div class="wsus__user_list">
    ...
    <div class="wsus__favourite_user">
        ...
        @forelse($GetFavoriteList as $favorite)
            <div class="col-xl-3 messenger-list-item" data-id="{{ $favorite->id }}">
                <a href="#" class="wsus__favourite_item">
                    <div class="img">
                        @if (!empty($favorite->avatar))

                            <img src="{{ asset('storage/'.$favorite->avatar) }}" alt="User" class="img-fluid">
                        @else
